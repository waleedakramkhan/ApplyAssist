...
from applyassist.database import get_connection, init_db, ensure_columns
...
def set_proxy(proxy_str: str | None):
    ...
    if proxy_str:
        from applyassist.discovery.jobspy import parse_proxy
...
def extract_with_llm(page, url: str) -> dict:
    ...
    try:
        ...
        from applyassist.discovery.smartextract import extract_json
